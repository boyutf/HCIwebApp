...
var ticketPrices = [10.5, 8.5, 8.5];
    ...
    a=a.replace('+',' ');
    a=a.replace('+',' ');
    document.write("Votre selection est:"+a.substr(5));
...
function calculateTotal()
{
    ...
    if (totalTickets > MAX_TICKET)
    {
       ...
       divobj.innerHTML = "Sélectionnez un total de "+ MAX_TICKET +" billets ou moins.";
    ...
    else
    {
       ...
       var divobj = document.getElementById('totalPrice');
       divobj.style.display='block';
       divobj.innerHTML = "Prix total $"+ticketPrice;
       if ( ticketPrice == 0)
       {
          document.getElementById("totalPrice").style.backgroundColor = "#f00";
       }
...
function selectSeat()
{
   ...
   {
      document.getElementById("seatTotal").innerHTML = "Veuillez selectionner le (s) billet (s).";
   ...
   else if ( currentNumSeats > currentNumTickets )
   {
      ...
      document.getElementById("seatTotal").innerHTML = "S'il vous plait ajouter " + diff + " billet (s) ou enlever siege (s).";
      document.getElementById("seatTotal").style.backgroundColor = "#f00";
   }
   ...
   else
   {
      ...
      {
         document.getElementById("seatTotal").innerHTML = txt+"Sieges selectionnes.";
      ...
      else
      {
         ...
         document.getElementById("seatTotal").innerHTML = txt + "Veuillez selectionner " + diff + " siege (s).";
         document.getElementById("seatTotal").style.backgroundColor = "#f00";
      }
   }
}
